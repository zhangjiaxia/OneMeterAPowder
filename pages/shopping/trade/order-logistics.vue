			...
			<view class="uni-flex uni-row">
				...
				<view class="uni-flex uni-column rest">
					<view class="uni-flex">
						...
						<view class="company-type">{{info.deliveryName}}</view>
					</view>
					<view class="uni-flex">
						<view class="company">物流单号：</view>
						<view class="company-type">{{info.deliveryNo}}</view>
					</view>
				</view>
			</view>
		</view>
		<view style="background: #FFFFFF;" v-if="options[0] && options[0].context">
			<view class="steps">
